...
return {
  -- LSP Plugins
  {
    ...
    dependencies = {
      ...
      -- Provides visual feedback for LSP operations like loading, progress, and notifications
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          if client and client:supports_method(vim.lsp.protocol.Methods.textDocument_documentHighlight) then
            ...
            -- Clear on cursor move and when entering insert mode. Insert-mode
            -- triggers (CursorHoldI/CursorMovedI) are intentionally omitted so
            -- the documentHighlight LSP request stays off the typing hot path.
