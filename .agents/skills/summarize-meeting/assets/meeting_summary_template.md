...
1. **[Decision statement]** -- [Brief rationale or context]. Decided by [who].
2. **[Decision statement]** -- [Brief rationale or context]. Decided by [who].

## Open Questions

1. [Unresolved question]? ([Who is expected to answer, by when])
2. [Unresolved question]? ([Who is expected to answer, by when])

---

**File name:** `Meeting-Summary-[YYYY-MM-DD]-[topic-slug].md`
**Distributed to:** [List of recipients]
**Next meeting:** [Date and time, if recurring]
