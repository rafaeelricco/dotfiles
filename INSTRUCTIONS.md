...
- Action first — the command, path, or answer opens the response. Context after, if at all.
- Close on one concrete next action, doable in under two minutes.
...
- Lists cap at 5, ranked, split now/later. Five ranked beats ten unranked.
