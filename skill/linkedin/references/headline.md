...
```text
Role | Keyword 1 | Keyword 2 | Keyword 3 | Keyword 4 | Keyword 5
```
...
```text
Marketing Analyst | Digital Marketing | Performance | Google Ads | Meta Ads | Analytics
Logistics Specialist | Supply Chain | Planning | Inventory Control | KPIs | SAP
Senior Software Engineer | Full Stack | React | Node.js | Cloud | Architecture
HR Business Partner | HRBP | People Management | Performance | Culture | Leadership
Customer Success Manager | Portfolio Management | Retention | Expansion | Relationships | Performance
Relationship Manager | B2B | Credit | Financial Analysis | Negotiation | Corporate Portfolio
```
...
```text
Software Engineer | Node.js | AWS | Back-end
```
...
Pick one role and one area, then build the headline around it.

```text
Administrative Assistant | General Administration | Purchasing | Data Entry | Spreadsheet Control | ERP
```
