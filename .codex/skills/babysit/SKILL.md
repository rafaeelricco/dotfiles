...
description: >-
  ...
  fixing CI in a loop. Use when the user invokes `$babysit` to shepherd a pull
  request through review feedback, merge conflicts, and CI failures until it is
  mergeable.
---
